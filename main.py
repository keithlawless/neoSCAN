...
# Install file (+ console when available) logging. The GUI binaries are built
# with console=False, so without a file handler all log output is discarded —
# see app/logging_setup.py.
init_logging()
